...
BEGIN
    ...
    INSERT INTO entry (user_id, date, content, score) VALUES (NEW.id, '2021-02-02', 'I went to go get brunch with some people from work today, and we ended up going to this new place that opened near the pier. I ordered a really classic breakfast with eggs and bacon and toast. It was pretty good though they burnt my eggs a little. I want to go back to that place again soon!', -0.4);
    INSERT INTO entry (user_id, date, content, score) VALUES (NEW.id, '2021-02-01', 'The bookstore I always visit on my way home from work closed today. That makes me so sad. It was a nice place to get coffee and they always let me read for as long as I liked. I have to find another place now, but every other place seems so far away. I have too much on my mind, I''ll think about it tomorrow.', -0.2);
