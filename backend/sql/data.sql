...
BEGIN
    ...
    INSERT INTO entry (user_id, date, content, score) VALUES (NEW.id, '2021-02-25', 'I have never had a worse day in my life. I missed the bus to school, forgot my notebooks on my desk, and failed a test in English. I wanna diiieeeeeeee. At least mom made my favourite dumplings for dinner though. Those dumplings are the only thing keeping me from going insane right now.', 0.6);
    INSERT INTO entry (user_id, date, content, score) VALUES (NEW.id, '2021-02-24', 'My sleep schedule has been pretty crappy lately. I''ve had trouble sleeping at night, and have been falling asleep during the day. People have suggested that I start drinking teas at night, but I hate tea! Melatonin gets me to sleep, but doesn''t keep me there, unfortunately. I think it might be stressing me out a bit, which doesn''t help at all!', 0.8);
